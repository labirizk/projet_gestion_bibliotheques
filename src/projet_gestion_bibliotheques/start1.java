...
public class start1 {
	...
	Employe directeur1 = new Employe("Nicolazic","Damien","adresse directeur 1", dateEmbauche1,80000f,"direction", posteDirecteur);
	Employe directeur2 = new Employe("Abi Rizk","Lara", "adresse directeur 2", dateEmbauche2,80000f,"direction", posteDirecteur);
	Employe directeur3 = new Employe("Phoeung","Geneviève","adresse directeur 3", dateEmbauche3,80000f,"direction", posteDirecteur);
	Employe directeur4 = new Employe("Delhaye","Sadi","adresse directeur 4", dateEmbauche4,80000f,"direction", posteDirecteur);
	
	Employe employe1 = new Employe("Lavilley","Viencent","adresse employe 1", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	Employe employe2 = new Employe("Larabi","Hakim","adresse employe 2", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	Employe employe3 = new Employe("Laurent","Marc","adresse employe 3", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	
	Employe employe4 = new Employe("Montana","Camilo","adresse employe 4", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	Employe employe5 = new Employe("Nataf","Martin","adresse employe 5", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	Employe employe6 = new Employe("Tagniy-Hamou","lillia","adresse employe 6", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	
	Employe employe7 = new Employe("Ottmani","Zaid","adresse employe 7", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	Employe employe8 = new Employe("Lecoq","Ludovic","adresse employe 8", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	Employe employe9 = new Employe("Fernandes","Stéphane","adresse employe 9", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	
	Employe employe10 = new Employe("Oueslati","Wassim","adresse employe 10", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	Employe employe11 = new Employe("Nebot Almiñana","Javier","adresse employe 11", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	Employe employe12 = new Employe("M-Louise","Marvin","adresse employe 12", dateEmbauche1,20000f,"salarie", posteEmployePoly);
	...
	Bibliotheque bibToulouse     = new Bibliotheque("Toulouse",200,100000,80,directeur2,empList2,menList2,objectList2);
	Bibliotheque bibVilleurbanne = new Bibliotheque("Villeurbanne",150,50000,50,directeur3,empList3,menList3,objectList3);
	Bibliotheque bibSophia       = new Bibliotheque("Sophia",100,80000,40,directeur4,empList4,menList4,objectList4);
